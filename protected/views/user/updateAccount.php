...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->passwordField($model,'password',array('value'=>"",'size'=>30,'maxlength'=>128)); ?>
	...
	<div class="row">
		...
		<?php echo $form->passwordField($model,'new_password_repeat',array('size'=>30,'maxlength'=>128)); ?>
