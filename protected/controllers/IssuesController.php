...
class IssuesController extends Controller
{
	...
	{
		$reply = new IssuesReply;
		if (isset($_POST['IssuesReply']))
		{
			$reply->issues_id = $id;
			$reply->reply = $_POST['IssuesReply']['reply'];
			$reply->creator = Yii::app()->user->id;
			$reply->create_date = date("Y-m-d");
			$reply->save();
		}
